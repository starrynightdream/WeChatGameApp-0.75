    ...
    */
    rocketBroke(){
        ...
        cc.assetManager.loadBundle('preform', (err, bundle) => {
            bundle.load("Item/spiteItem", cc.Prefab, function (err, prefab) {
                let spiteItem = cc.instantiate(prefab);
                rocketBroke.addChild(spiteItem)
            });
            bundle.load("Item/explodeItem", cc.Prefab, function (err, prefab) {
    ...
    rocketStarted(){
        rocketBroke=this.node
        cc.assetManager.loadBundle('preform', (err, bundle) => {
            bundle.load("Item/flameItem", cc.Prefab, function (err, prefab) {
